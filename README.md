...
- 김의진 :
이번 미니 프로젝트를 통해 의사소통의 중요성을 깨달았다. 개발자는 역할 맡은 파트의 프로그래밍만 잘하면 되는 줄 알았는데 팀워크도 못지않게 중요하다는 걸 깨달을 수 있었던 프로젝트였다. 여러가지 갈등 상황 속에서 대처하는 방법을 익혔던 것 같고 성장할 수 있었다. 성공적인 프로젝트를 위해서는 개발 실력 뿐만 아니라 체계적인 설계, 원활한 의사소통도 정말 중요하다는 것을 느껴 개발뿐만 아니라 다른 역량도 골고루 갖춰나가야겠다는 생각이 들었다. 개발하며 veiw에서부터 sql까지 한 프로세스를 맡아 진행하면서 창고 관리 시스템의 코드 흐름을 알 수 있었다. 설계를 구상만 했을 때는 굵직한 기능만 구현하면 되는 줄 알았는데 막상 개발에 들어가니 세세한 부분을 놓쳤다는 생각이 들었고 여러 프로젝트를 통해 경험을 쌓아야겠다는 생각이 들었다.
