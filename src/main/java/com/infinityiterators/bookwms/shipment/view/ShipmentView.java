...
public class ShipmentView {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("3. 출고내역 조회");     // 주문서를 출력하면서 주문서에 있는 내용을 품절시켜야할지 아님 테이블을 삭제시킬지
            System.out.println("4. 뒤로 가기");
            System.out.print("메뉴를 선택해주세요 : ");   // 출고시킨 출고내역을 조회하면 됩니다 하지만 출고내용이 테이블에 남을 수 있을지 의문이네요
